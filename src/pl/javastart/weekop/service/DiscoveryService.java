...
public class DiscoveryService {
    ...
    public boolean updateDiscovery2(String id, String desc, String name) {
        DAOFactory factory = DAOFactory.getDAOFactory();
        DiscoveryDAO discoveryDao = factory.getDiscoveryDAO();
        boolean result = discoveryDao.update2(id, name, desc);
        return result;
    }
    
    
    
    public boolean deleteDiscovery(long id){
    	DAOFactory factory = DAOFactory.getDAOFactory();
    	DiscoveryDAO discoveryDAO = factory.getDiscoveryDAO();
    	discoveryDAO.delete(id);
    	return true;
    }
